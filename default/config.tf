...
data "oci_identity_tenancy"      "resident" {tenancy_id = var.solution.tenancy}
data "oci_identity_regions"      "tenancy" { }
data "oci_identity_availability_domains" "tenancy" {compartment_id = var.solution.tenancy}
data "oci_objectstorage_namespace"       "tenancy" {compartment_id = var.solution.tenancy}
