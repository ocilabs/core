...
====== Settings
* link:/default/resident/classification.json[Tenant Classification] : ...

* link:/default/resident/lifecycle.json[Lifecycle Stages] : ...

* link:/library/rfc6335.json[Standard Application Profiles (RFC 6335)] : ...
...
* link:/default/resident/budgets.json[Budgets] : ...

* link:/default/resident/alerts.json[Administrator Alerts] : ...

* link:/default/resident/periods.json[Monitoring Periods] : ...

====== Encryption
* link:/default/encryption/secrets.json[Secrets] :  ... 

* link:/default/encryption/signatures.json[Signatures] :  ... 

* link:/default/encryption/wallets.json[Wallets] :  ... 
...
* link:/default/network/sources.json[Traffic Sources] : ...

====== Database
* link:/default/database/adb.json[Autonomous Database] : ...

* link:/default/database/sizes.json[T-Shirt Sizes] : ...
